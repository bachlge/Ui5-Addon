...
@JsModule("@ui5/webcomponents-fiori/dist/NotificationList.js")
public class Ui5NotificationList extends Component implements HasComponents {

	private static final Logger LOGGER = LoggerFactory.getLogger(Ui5NotificationList.class);

	public Ui5NotificationList() {
	...
	@DomEvent("item-click")
	public static class ItemClickEvent extends ComponentEvent<Ui5NotificationList> {
		private Element item;
		public ItemClickEvent(Ui5NotificationList source, boolean fromClient,
	...
	@DomEvent("item-close")
	public static class ItemCloseEvent extends ComponentEvent<Ui5NotificationList> {
		private Element item;
		public ItemCloseEvent(Ui5NotificationList source, boolean fromClient,
				@EventData("element.item") Element item) {
			super(source, fromClient);
			LOGGER.info("Item click event occured - item=" + item);
			this.item = item;
	...
	public static class ItemDeleteEvent extends ComponentEvent<Ui5NotificationList> {
		private Element item;
		public ItemDeleteEvent(Ui5NotificationList source, boolean fromClient,
				@EventData("element.item") Element item) {
			super(source, fromClient);
			LOGGER.info("Item click event occured - item=" + item);
			this.item = item;
	...
	public static class ItemToggleEvent extends ComponentEvent<Ui5NotificationList> {
		private Element item;
		public ItemToggleEvent(Ui5NotificationList source, boolean fromClient,
				@EventData("element.item") Element item) {
			super(source, fromClient);
			LOGGER.info("Item click event occured - item=" + item);
			this.item = item;
	...
	@DomEvent("load-more")
	public static class LoadMoreEvent extends ComponentEvent<Ui5NotificationList> {
		public LoadMoreEvent(Ui5NotificationList source, boolean fromClient) {
			super(source, fromClient);
	...
	public static class SelectionChangeEvent extends ComponentEvent<Ui5NotificationList> {
		private List<Element> selectedItems;
		public SelectionChangeEvent(Ui5NotificationList source, boolean fromClient,
